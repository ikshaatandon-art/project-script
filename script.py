...
NUM_WORKERS = 3
RATE_LIMIT_PER_WORKER = 5      # requests per second per worker
REQUESTS_PER_WORKER = 5        # 5 requests per worker = 15 total requests per target
PACING_DELAY = 1.0 / RATE_LIMIT_PER_WORKER  # 0.2s (200 ms interval)
